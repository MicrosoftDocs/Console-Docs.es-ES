...
|      [**CreatePseudoConsole**](createpseudoconsole.md)      |                                                      Asigna un nuevo pseudoconsole para el proceso de llamada.                                                      |
...
|               [**ReadConsoleInput**](readconsoleinput.md)               |                                   Lee datos de un búfer de entrada de la consola y lo quita del búfer.                                   |
