...
| ESC \[ &lt; n &gt; E             | CNL       | Cursor siguiente línea                    | Cursor hacia abajo hasta el principio de &lt; &gt; la línea n de la ventanilla                                                               |
| ESC \[ &lt; n &gt; F             | CPL       | Línea de cursor anterior                | Cursor hasta el principio de &lt; &gt; la línea n de la ventanilla                                                                 |
...
**Nota:**  Left Ctrl + derecha Alt se trata como AltGr. Cuando ambos se ven juntos, se eliminarán y el valor Unicode del carácter presentado por el sistema se pasará al destino. El sistema traducirá previamente los valores de AltGr según la configuración de entrada del sistema actual.
...
**Nota:**  En el ejemplo anterior, la cadena ' `\x1b[31m` ' es la implementación de **Esc \[ &lt; n &gt; m** con &lt; n &gt; siendo 31.
